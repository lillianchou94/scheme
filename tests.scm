...
(begin (define y 36) (+ 3 7) (/ 2 4) (define z 8))
; expect z

(begin (/ 3 2) (display 252) (+ 2 2) (print 'this) (define thus 1))
; expect 252 this thus

(lambda (x) (* x x))
; expect (lambda (x) (* x x))

(lambda (z d) (cons z d))
; expect (lambda (z d) (cons z d))

(define fx (lambda (x) (/ x 2)))
; expect fx

(define fx1 (lambda () (lambda d (display 'this))))
; expect fx1
...
(lambda (x x) (* 2 x))
; expect Error: repeating formal parameters

(lambda (0 x a) (x))
; expect Error: parameters not well formed

(define (sum-of-triple x y)
  (+ (triple x) (triple y)))
; expect sum-of-triple

(sum-of-triple 3 1)
; expect 28

(define (f a)
  (sum-of-triple (+ a 1) (* a 2)))
(f 5)
; expect 1216

(define add_two (lambda (x) (+ x 2)))
;expect add_two

(define sum_add_two (lambda (x y) (+ (add_two x) (add_two y))))
; expect sum_add_two
